...
<html lang="en">
    ...
    <body>
        <div class="container">
            <img src="devchallenges.svg" style="width: 130.17px; height: 18px;"/>
            <div class="greeting" style="font-family: 'Noto Sans', sans-serif; font-weight: 400;"></div>
            ...
            <form class="login-form">
                <div class="greeting" style="font-family: 'Noto Sans', sans-serif; font-weight: 400;">
                    <p></p>
                </div>
            </form>
            <form class="login-form">
                <div class="greeting" style="font-family: 'Noto Sans', sans-serif; font-weight: 400; font-size: 16px;">
